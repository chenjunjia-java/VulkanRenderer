...
// Must match the UBO layout bound at binding=0 in C++ and in prefilter_capture.vert.
layout(binding = 0) uniform CaptureUniforms {
    mat4 projection;   // unused in fragment, but kept for std140 layout compatibility
    float roughness;
} ubo;
